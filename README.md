...
The portfolio spans **five tasks** mapped to five course modules, covering:
- Creating digital awareness content
...
│
├── task-1-presentation/
│   ├── Task1_Infographic_Brief_Notes.txt               
│   └── task-1.png
│
├── task-2-portfolio/
│   ├── Task2_Digital_Portfolio_Reflection_Notes           
│   ├── github.png           
│   ├── kaggle.png      
│   ├── linkedIn1.png
│   └──  linkedIn2.png
...
│   ├── HackerRank1.png              
│   ├── Task3_Platforms_Reflection.txt
│   ├── google-form-1.png        
...
Set up professional accounts across three platforms: **GitHub**, **LinkedIn**, and **Kaggle**. Each profile has been filled with foundational academic details. This task helped establish a long-term digital presence that can grow alongside my academic and professional journey.
...
🔗 **Digital Literacy Awareness Quiz (Google Form):** [Take the Quiz](https://forms.gle/9K3kEHu8vgvYrNmc7)
...
Researched and wrote a detailed case study on **Ransomware**, a cybercrime type highly relevant to college students in India. Also produced a prevention checklist with actionable safety tips including UPI-specific guidance and national reporting channels.
...
| Portfolio | ResearchGate | [kaggle.com](https://www.kaggle.com/) |
...
- [x] Task 1 – Infographic exported and uploaded
- [x] Task 2 – Profile screenshots added for all 3 platforms
- [x] Task 3 – HackerRank screenshot + Google Form link included
- [x] Task 4 – Email drafts + social media checklist saved
- [x] Task 5 – Case study and prevention checklist added
...
-  **Digital Literacy Quiz:** [https://forms.gle/9K3kEHu8vgvYrNmc7](https://forms.gle/9K3kEHu8vgvYrNmc7)
...
> *This project was completed as part of CSE0001 – Digital Literacy, a course at VIT Bhopal University. The GitHub repository itself forms a permanent part of my digital portfolio.*
